...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Debit.bank_account'
        db.add_column(u'balanced_debits', 'bank_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'debits', null=True, to=orm['django_balanced.BankAccount']),
                      keep_default=False)


        # Changing field 'Debit.card'
        db.alter_column(u'balanced_debits', 'card_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['django_balanced.Card']))

    def backwards(self, orm):
        # Deleting field 'Debit.bank_account'
        db.delete_column(u'balanced_debits', 'bank_account_id')


        # User chose to not deal with backwards NULL issues for 'Debit.card'
        raise RuntimeError("Cannot reverse this migration. 'Debit.card' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Debit.card'
        db.alter_column(u'balanced_debits', 'card_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_balanced.Card']))
